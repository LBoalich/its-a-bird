    ...
    return (
        <div>
            ...
            <article className="home-container">
                <img src={require("./homePics/punk-rock.webp")} alt="Punk Rock Cockatoo" className="home-img" id="left-top"/>
                <div className="home-font-container">
                    <img src={require("./homePics/cockatoos.webp")} alt="featherd font reading 'Cockatoos'" className="home-font-img"/>
                </div>
                ...
                <br />
                <img src={require("./homePics/dancing.webp")} alt="Breakdancing Cockatoo" className="home-img" id="right"/>
                ...
                <br />
                <img src={require("./homePics/singing.webp")} alt="Singing Cockatoo" className="home-img" id="left-bottom"/>
