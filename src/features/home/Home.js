    ...
    return (
        <div>
            ...
            <article className="home-container">
                <img src={require("./homePics/punk-rock-small.webp")} alt="Punk Rock Cockatoo" className="home-img" id="left-top"/>
                <div className="home-font-container">
                    <img src={require("./homePics/cockatoos-small.webp")} alt="featherd font reading 'Cockatoos'" className="home-font-img"/>
                </div>
                ...
                <br />
                <img src={require("./homePics/dancing-small.webp")} alt="Breakdancing Cockatoo" className="home-img" id="right"/>
                ...
                <br />
                <img src={require("./homePics/singing-small.webp")} alt="Singing Cockatoo" className="home-img" id="left-bottom"/>
